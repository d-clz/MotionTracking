...
class BMX160:
    ...
    BMX160_ACCEL_MG_LSB_2G          = (0.00006103515625)
    BMX160_ACCEL_MG_LSB_4G          = (0.0001220703125)
    BMX160_ACCEL_MG_LSB_8G          = (0.000244141)
    BMX160_ACCEL_MG_LSB_16G         = (0.000488281)
    
    BMX160_GYRO_SENSITIVITY_125DPS  = (0.0038110)
    BMX160_GYRO_SENSITIVITY_250DPS  = (0.0076293945)
    ...
    def begin(self):
        if not self.scan():
            ...
            time.sleep(0.02);
            #Set gyro range: 250 DPS
            self.write_bmx_reg(self._BMX160_GYRO_RANGE_ADDR, 0b00000011);
            time.sleep(0.01);
